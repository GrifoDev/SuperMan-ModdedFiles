...
.method public declared-synchronized resumeThread()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->notify()V
    :try_end_0
...
.method public run()V
    ...
    iget-boolean v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->isRunning:Z
    ...
    iget-boolean v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->isSuspended:Z

    if-eqz v5, :cond_3

    move-object/from16 v0, p0

    iget v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mTick:I
    ...
    iput v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mTick:I

    invoke-virtual/range {p0 .. p0}, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->wait()V
    :try_end_0
    ...
    iget-object v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mHolder:Landroid/view/SurfaceHolder;
    ...
    iget v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mCount:I

    add-int/lit8 v5, v5, 0x1

    move-object/from16 v0, p0

    iput v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mCount:I
    ...
    iget-object v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->this$0:Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView;

    invoke-static {v5}, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView;->-get0(Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView;)Ljava/lang/String;
    ...
    iget v5, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mMinInterval:I
    ...
    invoke-virtual {v5, v2}, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView;->drawFrame(Landroid/graphics/Canvas;)V
    :try_end_3
    ...
    iget-object v0, v0, Lcom/android/systemui/wallpaper/theme/OpenThemeSurfaceView$FrameDrawThread;->mHolder:Landroid/view/SurfaceHolder;
