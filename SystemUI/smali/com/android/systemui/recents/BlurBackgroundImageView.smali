.class public Lcom/android/systemui/recents/BlurBackgroundImageView;
.super Landroid/widget/ImageView;
.source "BlurBackgroundImageView.java"


# static fields
.field static ALPHA:I = 0x0
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/systemui/recents/BlurBackgroundImageView;->RADIUS:I

    const/high16 v0, 0x40f00000    # 7.5f

    sput v0, Lcom/android/systemui/recents/BlurBackgroundImageView;->DIVIDE:F

    const/16 v0, 0x0

    sput v0, Lcom/android/systemui/recents/BlurBackgroundImageView;->ALPHA:I

    const/4 v0, 0x0

    sput-object v0, Lcom/android/systemui/recents/BlurBackgroundImageView;->wallpaperManager:Landroid/app/WallpaperManager;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Lcom/android/systemui/recents/BlurBackgroundImageView;->wallpaperManager:Landroid/app/WallpaperManager;

    invoke-virtual {v0}, Landroid/app/WallpaperManager;->getBitmap()Landroid/graphics/Bitmap;

    move-result-object v0

    sget v1, Lcom/android/systemui/recents/BlurBackgroundImageView;->RADIUS:I

    sget v2, Lcom/android/systemui/recents/BlurBackgroundImageView;->DIVIDE:F

    sget v3, Lcom/android/systemui/recents/BlurBackgroundImageView;->ALPHA:I

    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/android/systemui/recents/BlurBackgroundImageView;->setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
...
.method public renderScriptBlur(Landroid/graphics/Bitmap;IFI)Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/systemui/recents/BlurBackgroundImageView;->getContext()Landroid/content/Context;
...
.method public setAlpha(I)V
    ...
    sput p1, Lcom/android/systemui/recents/BlurBackgroundImageView;->ALPHA:I
...
.method public setBlurImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    sget v0, Lcom/android/systemui/recents/BlurBackgroundImageView;->RADIUS:I

    sget v1, Lcom/android/systemui/recents/BlurBackgroundImageView;->DIVIDE:F

    sget v2, Lcom/android/systemui/recents/BlurBackgroundImageView;->ALPHA:I

    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/android/systemui/recents/BlurBackgroundImageView;->setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
...
.method public setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
    ...
    iget-object v1, p0, Lcom/android/systemui/recents/BlurBackgroundImageView;->mContext:Landroid/content/Context;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/systemui/recents/BlurBackgroundImageView;->jFastblur(Landroid/content/Context;Landroid/graphics/Bitmap;IFI)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/systemui/recents/BlurBackgroundImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V
...
.method public setBlurImageDrawable(Landroid/graphics/drawable/Drawable;IFI)V
    ...
    invoke-virtual {p0, v0, p2, p3, p4}, Lcom/android/systemui/recents/BlurBackgroundImageView;->setBlurImageBitmap(Landroid/graphics/Bitmap;IFI)V
...
.method public setWallpaperAsImage()V
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/android/systemui/recents/BlurBackgroundImageView;->setBlurImageDrawable(Landroid/graphics/drawable/Drawable;IFI)V
