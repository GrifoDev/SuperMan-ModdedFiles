.class public abstract Landroid/support/v17/leanback/app/MediaControllerGlue;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v17/leanback/app/MediaControllerGlue$1;
    }
.end annotation
...
# direct methods
.method static synthetic -wrap0(Landroid/support/v17/leanback/app/MediaControllerGlue;)V
    .locals 0

    invoke-virtual {p0}, Landroid/support/v17/leanback/app/MediaControllerGlue;->onMetadataChanged()V

    return-void
.end method

.method static synthetic -wrap1(Landroid/support/v17/leanback/app/MediaControllerGlue;)V
    .locals 0

    invoke-virtual {p0}, Landroid/support/v17/leanback/app/MediaControllerGlue;->onStateChanged()V
...
.method public getCurrentPosition()I
    ...
    iget-object v0, p0, Landroid/support/v17/leanback/app/MediaControllerGlue;->mMediaController:Landroid/support/v4/media/session/MediaControllerCompat;
...
.method public getCurrentSpeedId()I
    ...
    iget-object v3, p0, Landroid/support/v17/leanback/app/MediaControllerGlue;->mMediaController:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    invoke-virtual {p0}, Landroid/support/v17/leanback/app/MediaControllerGlue;->getFastForwardSpeeds()[I
    ...
    :cond_3
    invoke-virtual {p0}, Landroid/support/v17/leanback/app/MediaControllerGlue;->getRewindSpeeds()[I
...
.method public getMediaArt()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v17/leanback/app/MediaControllerGlue;->mMediaController:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    invoke-virtual {p0}, Landroid/support/v17/leanback/app/MediaControllerGlue;->getContext()Landroid/content/Context;
...
.method public getSupportedActions()J
    ...
    iget-object v4, p0, Landroid/support/v17/leanback/app/MediaControllerGlue;->mMediaController:Landroid/support/v4/media/session/MediaControllerCompat;
...
.method public hasValidMedia()Z
    ...
    iget-object v1, p0, Landroid/support/v17/leanback/app/MediaControllerGlue;->mMediaController:Landroid/support/v4/media/session/MediaControllerCompat;
