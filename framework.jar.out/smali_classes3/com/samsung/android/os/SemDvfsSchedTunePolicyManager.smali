...
.method public acquire(I)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->LOG_TAG:Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mIsAcquired:Z
    ...
    iget-object v3, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mTagName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->logOnEng(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v1, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mIsAcquired:Z
    ...
    :cond_1
    iget v1, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mType:I

    const/16 v2, 0x1d

    if-ne v1, v2, :cond_2

    iget-object v1, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mDvfsRequest:Landroid/os/CustomFrequencyManager$FrequencyRequest;
    ...
    iget-object v6, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mTagName:Ljava/lang/String;

    iget-object v7, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mDvfsRequest:Landroid/os/CustomFrequencyManager$FrequencyRequest;
    ...
    iput-boolean v1, p0, Lcom/samsung/android/os/SemDvfsSchedTunePolicyManager;->mIsAcquired:Z
    :try_end_0
