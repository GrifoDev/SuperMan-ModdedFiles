...
# direct methods
.method static synthetic -get0(Lcom/android/internal/widget/RecyclerView$ViewHolder;)I
    .locals 1
...
.method static synthetic -get1(Lcom/android/internal/widget/RecyclerView$ViewHolder;)Z
    .locals 1
...
.method static synthetic -set0(Lcom/android/internal/widget/RecyclerView$ViewHolder;Z)Z
    .locals 0
...
.method static synthetic -set1(Lcom/android/internal/widget/RecyclerView$ViewHolder;Lcom/android/internal/widget/RecyclerView$Recycler;)Lcom/android/internal/widget/RecyclerView$Recycler;
    .locals 0
...
.method static synthetic -wrap0(Lcom/android/internal/widget/RecyclerView$ViewHolder;)Z
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/internal/widget/RecyclerView$ViewHolder;)Z
    .locals 1
...
.method static synthetic -wrap2(Lcom/android/internal/widget/RecyclerView$ViewHolder;Lcom/android/internal/widget/RecyclerView;)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/internal/widget/RecyclerView$ViewHolder;Lcom/android/internal/widget/RecyclerView;)V
    .locals 0
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPosition:I

    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mOldPosition:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mItemId:J

    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mItemViewType:I

    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPreLayoutPosition:I
    ...
    iput-object v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPayloads:Ljava/util/List;

    iput-object v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mUnmodifiedPayloads:Ljava/util/List;

    iput v4, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mIsRecyclableCount:I

    iput-object v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mScrapContainer:Lcom/android/internal/widget/RecyclerView$Recycler;

    iput-boolean v4, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mInChangeScrap:Z

    iput v4, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mWasImportantForAccessibilityBeforeHidden:I

    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPendingAccessibilityState:I
...
.method resetInternal()V
    ...
    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mFlags:I

    iput v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPosition:I

    iput v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mOldPosition:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mItemId:J

    iput v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPreLayoutPosition:I

    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mIsRecyclableCount:I

    iput-object v4, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mShadowedHolder:Lcom/android/internal/widget/RecyclerView$ViewHolder;

    iput-object v4, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mShadowingHolder:Lcom/android/internal/widget/RecyclerView$ViewHolder;

    invoke-virtual {p0}, Lcom/android/internal/widget/RecyclerView$ViewHolder;->clearPayload()V

    iput v3, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mWasImportantForAccessibilityBeforeHidden:I

    iput v2, p0, Lcom/android/internal/widget/RecyclerView$ViewHolder;->mPendingAccessibilityState:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/internal/widget/RecyclerView$ViewHolder;->hashCode()I
