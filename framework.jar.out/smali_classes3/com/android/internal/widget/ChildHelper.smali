...
.method private getOffset(I)I
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/internal/widget/ChildHelper;->mCallback:Lcom/android/internal/widget/ChildHelper$Callback;

    invoke-interface {v4}, Lcom/android/internal/widget/ChildHelper$Callback;->getChildCount()I
    ...
    iget-object v4, p0, Lcom/android/internal/widget/ChildHelper;->mBucket:Lcom/android/internal/widget/ChildHelper$Bucket;

    invoke-virtual {v4, v2}, Lcom/android/internal/widget/ChildHelper$Bucket;->countOnesBefore(I)I
    ...
    invoke-virtual {v4, v2}, Lcom/android/internal/widget/ChildHelper$Bucket;->get(I)Z
...
.method findHiddenNonRemovedView(I)Landroid/view/View;
    ...
    iget-object v4, p0, Lcom/android/internal/widget/ChildHelper;->mHiddenViews:Ljava/util/List;
    ...
    invoke-interface {v4, v3}, Lcom/android/internal/widget/ChildHelper$Callback;->getChildViewHolder(Landroid/view/View;)Lcom/android/internal/widget/RecyclerView$ViewHolder;
...
.method hide(Landroid/view/View;)V
    ...
    invoke-interface {v1, p1}, Lcom/android/internal/widget/ChildHelper$Callback;->indexOfChild(Landroid/view/View;)I
...
.method removeAllViewsUnfiltered()V
    ...
    invoke-virtual {v1}, Lcom/android/internal/widget/ChildHelper$Bucket;->reset()V
    ...
    invoke-interface {v2, v1}, Lcom/android/internal/widget/ChildHelper$Callback;->onLeftHiddenState(Landroid/view/View;)V
    ...
    invoke-interface {v1}, Lcom/android/internal/widget/ChildHelper$Callback;->removeAllViews()V
...
.method removeViewAt(I)V
    ...
    invoke-interface {v2, v0}, Lcom/android/internal/widget/ChildHelper$Callback;->getChildAt(I)Landroid/view/View;
