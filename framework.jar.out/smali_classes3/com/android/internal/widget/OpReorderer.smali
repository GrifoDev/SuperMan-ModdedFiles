...
.method private swapMoveOp(Ljava/util/List;II)V
    ...
    check-cast v5, Lcom/android/internal/widget/AdapterHelper$UpdateOp;

    iget v0, v5, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->cmd:I
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/internal/widget/OpReorderer;->swapMoveRemove(Ljava/util/List;ILcom/android/internal/widget/AdapterHelper$UpdateOp;ILcom/android/internal/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/internal/widget/OpReorderer;->swapMoveAdd(Ljava/util/List;ILcom/android/internal/widget/AdapterHelper$UpdateOp;ILcom/android/internal/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/internal/widget/OpReorderer;->swapMoveUpdate(Ljava/util/List;ILcom/android/internal/widget/AdapterHelper$UpdateOp;ILcom/android/internal/widget/AdapterHelper$UpdateOp;)V
...
.method swapMoveRemove(Ljava/util/List;ILcom/android/internal/widget/AdapterHelper$UpdateOp;ILcom/android/internal/widget/AdapterHelper$UpdateOp;)V
    ...
    iput v4, p5, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->positionStart:I
    ...
    invoke-interface {v4, p3}, Lcom/android/internal/widget/OpReorderer$Callback;->recycleUpdateOp(Lcom/android/internal/widget/AdapterHelper$UpdateOp;)V
    ...
    iput v8, p3, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->cmd:I
    ...
    invoke-interface {v4, p5}, Lcom/android/internal/widget/OpReorderer$Callback;->recycleUpdateOp(Lcom/android/internal/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-interface {v4, v8, v5, v2, v7}, Lcom/android/internal/widget/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Lcom/android/internal/widget/AdapterHelper$UpdateOp;
    ...
    iget v5, v0, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->positionStart:I

    if-le v4, v5, :cond_8

    iget v4, p3, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->positionStart:I

    iget v5, v0, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->itemCount:I

    sub-int/2addr v4, v5

    iput v4, p3, Lcom/android/internal/widget/AdapterHelper$UpdateOp;->positionStart:I
...
.method swapMoveUpdate(Ljava/util/List;ILcom/android/internal/widget/AdapterHelper$UpdateOp;ILcom/android/internal/widget/AdapterHelper$UpdateOp;)V
    ...
    invoke-interface {v3, v7, v4, v6, v5}, Lcom/android/internal/widget/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Lcom/android/internal/widget/AdapterHelper$UpdateOp;
    ...
    invoke-interface {v3, v7, v4, v2, v5}, Lcom/android/internal/widget/OpReorderer$Callback;->obtainUpdateOp(IIILjava/lang/Object;)Lcom/android/internal/widget/AdapterHelper$UpdateOp;
