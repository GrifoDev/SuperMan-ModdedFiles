...
.method public onCharacteristicRead(Ljava/lang/String;II[B)V
    ...
    invoke-static {v3}, Landroid/bluetooth/BluetoothGatt;->-get2(Landroid/bluetooth/BluetoothGatt;)I
    ...
    invoke-static {v3}, Landroid/bluetooth/BluetoothGatt;->-get9(Landroid/bluetooth/BluetoothGatt;)Landroid/bluetooth/IBluetoothGatt;
    ...
    invoke-direct {v4, p0, v1, p2}, Landroid/bluetooth/BluetoothGatt$1$6;-><init>(Landroid/bluetooth/BluetoothGatt$1;Landroid/bluetooth/BluetoothGattCharacteristic;I)V
...
.method public onCharacteristicWrite(Ljava/lang/String;II)V
    ...
    invoke-static {v0}, Landroid/bluetooth/BluetoothGatt;->-get2(Landroid/bluetooth/BluetoothGatt;)I
    ...
    invoke-static {v0}, Landroid/bluetooth/BluetoothGatt;->-get9(Landroid/bluetooth/BluetoothGatt;)Landroid/bluetooth/IBluetoothGatt;
...
.method public onClientConnectionState(IIZLjava/lang/String;)V
    ...
    const-string/jumbo v3, "[0003]{0003}(02::"
    ...
    new-instance v3, Landroid/bluetooth/BluetoothGatt$1$4;

    invoke-direct {v3, p0, p1, v0}, Landroid/bluetooth/BluetoothGatt$1$4;-><init>(Landroid/bluetooth/BluetoothGatt$1;II)V

    invoke-static {v2, v3}, Landroid/bluetooth/BluetoothGatt;->-wrap0(Landroid/bluetooth/BluetoothGatt;Ljava/lang/Runnable;)V

    iget-object v2, p0, Landroid/bluetooth/BluetoothGatt$1;->this$0:Landroid/bluetooth/BluetoothGatt;

    invoke-static {v2}, Landroid/bluetooth/BluetoothGatt;->-get11(Landroid/bluetooth/BluetoothGatt;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Landroid/bluetooth/BluetoothGatt;->-get7(Landroid/bluetooth/BluetoothGatt;)Ljava/lang/Boolean;
...
.method public onClientRegistered(II)V
    ...
    invoke-static {v0}, Landroid/bluetooth/BluetoothGatt;->-get11(Landroid/bluetooth/BluetoothGatt;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Landroid/bluetooth/BluetoothGatt;->-get3(Landroid/bluetooth/BluetoothGatt;)Z
    ...
    invoke-static {v4}, Landroid/bluetooth/BluetoothGatt;->-get12(Landroid/bluetooth/BluetoothGatt;)I

    move-result v4

    iget-object v5, p0, Landroid/bluetooth/BluetoothGatt$1;->this$0:Landroid/bluetooth/BluetoothGatt;

    invoke-static {v5}, Landroid/bluetooth/BluetoothGatt;->-get8(Landroid/bluetooth/BluetoothGatt;)I

    move-result v5

    iget-object v6, p0, Landroid/bluetooth/BluetoothGatt$1;->this$0:Landroid/bluetooth/BluetoothGatt;

    invoke-static {v6}, Landroid/bluetooth/BluetoothGatt;->-get13(Landroid/bluetooth/BluetoothGatt;)Z
...
.method public onDescriptorRead(Ljava/lang/String;II[B)V
    ...
    invoke-direct {v4, p0, v1, p2}, Landroid/bluetooth/BluetoothGatt$1$9;-><init>(Landroid/bluetooth/BluetoothGatt$1;Landroid/bluetooth/BluetoothGattDescriptor;I)V
...
.method public onNotify(Ljava/lang/String;I[B)V
    ...
    invoke-direct {v2, p0, v0}, Landroid/bluetooth/BluetoothGatt$1$8;-><init>(Landroid/bluetooth/BluetoothGatt$1;Landroid/bluetooth/BluetoothGattCharacteristic;)V
...
.method public onSearchComplete(Ljava/lang/String;Ljava/util/List;I)V
    ...
    invoke-static {v9}, Landroid/bluetooth/BluetoothGatt;->-get6(Landroid/bluetooth/BluetoothGatt;)Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-static {v9}, Landroid/bluetooth/BluetoothGatt;->-get10(Landroid/bluetooth/BluetoothGatt;)Ljava/util/List;
