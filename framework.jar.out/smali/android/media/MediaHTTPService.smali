...
.method public makeHTTPConnection()Landroid/media/IMediaHTTPConnection;
    ...
    iget-object v6, p0, Landroid/media/MediaHTTPService;->mCookieStoreInitialized:Ljava/lang/Boolean;

    monitor-enter v6

    :try_start_0
    iget-object v5, p0, Landroid/media/MediaHTTPService;->mCookieStoreInitialized:Ljava/lang/Boolean;
    ...
    const-string/jumbo v5, "MediaHTTPService"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "makeHTTPConnection: CookieManager created: "
    ...
    :goto_0
    iget-object v5, p0, Landroid/media/MediaHTTPService;->mCookies:Ljava/util/List;
    ...
    const-string/jumbo v8, "makeHTTPConnection: CookieStore.add"
    ...
    const-string/jumbo v8, "makeHTTPConnection: CookieManager("
    ...
    iput-object v5, p0, Landroid/media/MediaHTTPService;->mCookieStoreInitialized:Ljava/lang/Boolean;
    ...
    const-string/jumbo v8, "makeHTTPConnection("
    ...
    const-string/jumbo v8, "): cookieManager: "
    ...
    iget-object v8, p0, Landroid/media/MediaHTTPService;->mCookies:Ljava/util/List;
    ...
    new-instance v5, Landroid/media/MediaHTTPConnection;

    invoke-direct {v5}, Landroid/media/MediaHTTPConnection;-><init>()V
