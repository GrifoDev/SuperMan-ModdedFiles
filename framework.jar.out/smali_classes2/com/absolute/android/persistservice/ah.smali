...
.method constructor <init>(Ljava/lang/String;ZLcom/absolute/android/persistservice/v;)V
    ...
    iput-boolean v1, p0, Lcom/absolute/android/persistservice/ah;->d:Z

    iput-object v2, p0, Lcom/absolute/android/persistservice/ah;->e:Ljava/io/FileInputStream;

    iput-object v2, p0, Lcom/absolute/android/persistservice/ah;->f:Ljava/io/FileOutputStream;
    ...
    iget-object v2, p0, Lcom/absolute/android/persistservice/ah;->a:Ljava/lang/String;

    invoke-direct {v1, v2}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lcom/absolute/android/persistservice/ah;->b:Ljava/io/File;
...
.method public read([B)I
    ...
    :try_start_0
    iget-object v3, p0, Lcom/absolute/android/persistservice/ah;->e:Ljava/io/FileInputStream;
    ...
    iget-object v4, p0, Lcom/absolute/android/persistservice/ah;->b:Ljava/io/File;

    invoke-direct {v3, v4}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V

    iput-object v3, p0, Lcom/absolute/android/persistservice/ah;->e:Ljava/io/FileInputStream;
    :try_end_0
    ...
    const-string/jumbo v4, "IOException for read() from Persisted File: "
...
.method public skip(J)J
    ...
    :try_start_0
    iget-object v4, p0, Lcom/absolute/android/persistservice/ah;->e:Ljava/io/FileInputStream;
    ...
    iget-object v5, p0, Lcom/absolute/android/persistservice/ah;->b:Ljava/io/File;

    invoke-direct {v4, v5}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V

    iput-object v4, p0, Lcom/absolute/android/persistservice/ah;->e:Ljava/io/FileInputStream;
    :try_end_0
    .catch Ljava/io/FileNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    const-string/jumbo v5, "FileNotFoundException for skip() on Persisted File: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/absolute/android/persistservice/ah;->a:Ljava/lang/String;
    ...
    const-string/jumbo v5, "IOException for skip() on Persisted File: "
...
.method public write([B)I
    ...
    :try_start_0
    iget-object v3, p0, Lcom/absolute/android/persistservice/ah;->f:Ljava/io/FileOutputStream;
    ...
    iget-boolean v5, p0, Lcom/absolute/android/persistservice/ah;->d:Z

    invoke-direct {v3, v4, v5}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V

    iput-object v3, p0, Lcom/absolute/android/persistservice/ah;->f:Ljava/io/FileOutputStream;
    :try_end_0
    .catch Ljava/io/FileNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    const-string/jumbo v4, "FileNotFoundException for write() to Persisted File: "
    ...
    const-string/jumbo v4, "IOException for write() to Persisted File: "
...
.method public writeWithCount([BII)I
    ...
    invoke-virtual {v3, p1, p2, p3}, Ljava/io/FileOutputStream;->write([BII)V
