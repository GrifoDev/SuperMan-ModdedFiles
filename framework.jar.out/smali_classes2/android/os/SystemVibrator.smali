...
.method public semIsEnhancedPatternProvided()Z
    ...
    invoke-interface {v1}, Landroid/os/IVibratorService;->semIsHapticEngineSupported()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public semSetVibrationMute(Landroid/os/Vibrator$SemMagnitudeTypes;Z)Ljava/util/List;
    ...
    iget-object v4, p0, Landroid/os/SystemVibrator;->mPackageName:Ljava/lang/String;

    iget-object v5, p0, Landroid/os/SystemVibrator;->mToken:Landroid/os/Binder;

    invoke-interface {v2, v3, p2, v4, v5}, Landroid/os/IVibratorService;->semSetVibrationMute(Ljava/lang/String;ZLjava/lang/String;Landroid/os/IBinder;)Ljava/util/List;
    ...
    const-string/jumbo v4, "Updated condition of vibration by "
    ...
    const-string/jumbo v3, "Failed to set."
...
.method public semVibrate(ILjava/lang/String;JLandroid/media/AudioAttributes;ILjava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p3, p4, v0}, Landroid/os/VibrationEffect;->createOneShot(JI)Landroid/os/VibrationEffect;
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/os/SystemVibrator;->semVibrate(ILjava/lang/String;Landroid/os/VibrationEffect;Landroid/media/AudioAttributes;ILjava/lang/String;)V
    :try_end_0
    ...
    const-string/jumbo v1, "Failed to create VibrationEffect"
...
.method public semVibrate(ILjava/lang/String;Landroid/os/VibrationEffect;Landroid/media/AudioAttributes;ILjava/lang/String;)V
    .locals 9
    ...
    const-string/jumbo v2, "semVibrate - PUID: "
    ...
    invoke-interface/range {v0 .. v7}, Landroid/os/IVibratorService;->vibrateMagnitude(ILjava/lang/String;Landroid/os/VibrationEffect;ILandroid/os/IBinder;ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public semVibrate(ILjava/lang/String;Landroid/os/VibrationEffect;Landroid/media/AudioAttributes;Landroid/os/Vibrator$SemMagnitudeTypes;)V
    ...
    invoke-virtual {p5}, Landroid/os/Vibrator$SemMagnitudeTypes;->toString()Ljava/lang/String;
...
.method public semVibrate(ILjava/lang/String;[JILandroid/media/AudioAttributes;ILjava/lang/String;)V
    ...
    :cond_1
    :try_start_0
    invoke-static {p3, p4}, Landroid/os/VibrationEffect;->createWaveform([JI)Landroid/os/VibrationEffect;
...
.method public vibrate(ILjava/lang/String;Landroid/os/VibrationEffect;Landroid/media/AudioAttributes;)V
    ...
    const-string/jumbo v2, "Called vibrate(int, String, VibrationEffect, AudioAttributes) API - PUID: "
