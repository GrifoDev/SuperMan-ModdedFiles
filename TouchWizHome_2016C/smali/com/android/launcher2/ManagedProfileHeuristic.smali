...
.method private constructor <init>(Landroid/content/Context;Lcom/android/launcher2/compat/UserHandleCompat;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/launcher2/compat/UserManagerCompat;->getUserCreationTime(Lcom/android/launcher2/compat/UserHandleCompat;)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mUserCreationTime:J
...
.method private markForAddition(Lcom/android/launcher2/compat/LauncherActivityInfoCompat;J)V
    .locals 8

    const-wide/32 v6, 0x1b77400

    iget-wide v4, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mUserCreationTime:J

    add-long v2, v4, v6

    const-string v1, "ManagedProfileHeuristic"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "markForAddition install time : "
...
.method public processPackageAdd([Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mPrefs:Landroid/content/SharedPreferences;
    ...
    const-string v10, "processPackageAdd but work folder is not exist in shared preference"
    ...
    iput-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mHomescreenApps:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mWorkFolderApps:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mWorkFolderItems:Ljava/util/ArrayList;

    new-instance v7, Ljava/util/HashSet;

    invoke-direct {v7}, Ljava/util/HashSet;-><init>()V

    invoke-direct {p0, v7}, Lcom/android/launcher2/ManagedProfileHeuristic;->getUserApps(Ljava/util/HashSet;)Z
    ...
    iget-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mContext:Landroid/content/Context;
    ...
    const-string v13, "processPackageAdd : "
    ...
    iget-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mUser:Lcom/android/launcher2/compat/UserHandleCompat;

    invoke-virtual {v4, v6, v9}, Lcom/android/launcher2/compat/LauncherAppsCompat;->getActivityList(Ljava/lang/String;Lcom/android/launcher2/compat/UserHandleCompat;)Ljava/util/List;
    ...
    check-cast v9, Lcom/android/launcher2/compat/LauncherActivityInfoCompat;

    invoke-direct {p0, v9, v2, v3}, Lcom/android/launcher2/ManagedProfileHeuristic;->markForAddition(Lcom/android/launcher2/compat/LauncherActivityInfoCompat;J)V
    ...
    iget-object v10, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mPackageSetKey:Ljava/lang/String;

    invoke-interface {v9, v10, v7}, Landroid/content/SharedPreferences$Editor;->putStringSet(Ljava/lang/String;Ljava/util/Set;)Landroid/content/SharedPreferences$Editor;

    move-result-object v9

    invoke-interface {v9}, Landroid/content/SharedPreferences$Editor;->apply()V

    invoke-direct {p0, v8}, Lcom/android/launcher2/ManagedProfileHeuristic;->finalizeAdditions(Z)V
...
.method public processUserApps(Ljava/util/List;)V
    ...
    iput-object v8, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mHomescreenApps:Ljava/util/ArrayList;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mWorkFolderApps:Ljava/util/ArrayList;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mWorkFolderItems:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1, v10, v11}, Lcom/android/launcher2/ManagedProfileHeuristic;->markForAddition(Lcom/android/launcher2/compat/LauncherActivityInfoCompat;J)V
    :try_end_0
    ...
    iget-object v8, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mPrefs:Landroid/content/SharedPreferences;

    invoke-interface {v8}, Landroid/content/SharedPreferences;->edit()Landroid/content/SharedPreferences$Editor;

    move-result-object v8

    iget-object v9, p0, Lcom/android/launcher2/ManagedProfileHeuristic;->mPackageSetKey:Ljava/lang/String;

    invoke-interface {v8, v9, v5}, Landroid/content/SharedPreferences$Editor;->putStringSet(Ljava/lang/String;Ljava/util/Set;)Landroid/content/SharedPreferences$Editor;

    move-result-object v8

    invoke-interface {v8}, Landroid/content/SharedPreferences$Editor;->apply()V

    invoke-direct {p0, v7}, Lcom/android/launcher2/ManagedProfileHeuristic;->finalizeAdditions(Z)V
