...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;Landroid/bluetooth/BluetoothDevice;)V
    ...
    const-string/jumbo v7, "ACTION_BOND_STATE_CHANGED with no EXTRA_DEVICE"
    ...
    invoke-static {v6}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->-get1(Lcom/android/settingslib/bluetooth/BluetoothEventManager;)Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;
    ...
    const-string/jumbo v8, "CachedBluetoothDevice for device "
    ...
    const-string/jumbo v8, " not found, calling readPairedDevices()."
    ...
    const-string/jumbo v8, "Got bonding state changed for "
    ...
    const-string/jumbo v8, ", but we have no record of that device."
    ...
    const-string/jumbo v8, ", but device not added in cache."
    ...
    const-string/jumbo v7, "CachedBluetoothDevice was created from paired devices. It will be refreshed."
    ...
    const-string/jumbo v6, "android.bluetooth.device.extra.REASON"
    ...
    const-string/jumbo v8, "Command sent successfully:REMOVE_BOND "
    ...
    const-string/jumbo v8, "Framework rejected command immediately:REMOVE_BOND "
    ...
    invoke-virtual {p3, v9}, Landroid/bluetooth/BluetoothDevice;->setAlias(Ljava/lang/String;)Z
