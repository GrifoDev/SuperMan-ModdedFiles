...
.method private declared-synchronized inflateInCallButtons(Landroid/view/View;)V
    ...
    :try_start_0
    const-string v8, "inflateInCallButtons present"
    ...
    sput-boolean v8, Lcom/android/incallui/secrcs/RcsShareUI;->mIsExtraVolumeAvailable:Z

    const/4 v8, 0x1

    sput-boolean v8, Lcom/android/incallui/secrcs/RcsShareUI;->mIsCallPlusAvailable:Z
    ...
    sget-boolean v8, Lcom/android/incallui/secrcs/RcsShareUI;->isInCallRemote:Z

    if-eqz v8, :cond_19

    sget-boolean v8, Lcom/android/incallui/secrcs/RcsShareUI;->isInCallSelf:Z
    ...
    sget-boolean v8, Lcom/android/incallui/secrcs/RcsShareUI;->isCraneRemote:Z
    ...
    :cond_1c
    const-string v8, "callplus button disable 6"
    ...
    const-string v8, "callplus button disable 7"
...
.method private declared-synchronized inflatePagerContainer()V
    ...
    const-string v2, "inflatePagerContainer: mInCallButtonLayout :"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/incallui/fragment/VoiceCallButtonCallPlusFragment;->mInCallButtonLayout:Landroid/view/ViewGroup;
...
.method private switchToViLTECallClicked()V
    ...
    :cond_0
    const-string v0, "low battery or critical battery"
...
.method public updateUiEntryPoint(Landroid/database/Cursor;)V
    ...
    const-string v5, "callplus button enable"
    ...
    :cond_5
    const-string v5, "callplus button disable 2"
    ...
    :cond_d
    const-string v5, "updateUiEntryPoint else part "
    ...
    const-string v5, "updateUiEntryPoint  RcsSwitch true"
    ...
    :cond_12
    const-string v5, "callplus button disable 4"
    ...
    :cond_16
    const-string v5, "updateUiEntryPoint RcsSwitch false"

    invoke-static {p0, v5, v3}, Lcom/android/incallui/Log;->d(Ljava/lang/Object;Ljava/lang/String;Z)V

    iput-boolean v4, p0, Lcom/android/incallui/fragment/VoiceCallButtonCallPlusFragment;->isUiEntery:Z

    const-string v5, "callplus button disable 5"
