...
.method public update(Lcom/android/incallui/CallList;)V
    ...
    const-string v7, "update currentCall "
    ...
    invoke-static {v0, v1, v7}, Lcom/android/incallui/Log;->d(Ljava/lang/Object;Ljava/lang/String;Z)V
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/incallui/util/InCallUtils;->needToDisplayVzwNewConfCallUI(Lcom/android/incallui/Call;)Z

    move-result v1

    if-nez v1, :cond_2

    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/Call;->getChildCallIds()Ljava/util/List;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/Call;->isConferenceCall()Z
    ...
    const-string v7, "update currentCall.getChildCallIds().size() :"
    ...
    const-string v7, "update callList.getNumberOfConferencedCall() :"
    ...
    const-string v7, "update callList.getDisconnectedCall() :"
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/Call;->setSelfChildCallIds()V
    ...
    const-string v7, "Old Number of calls is "
    ...
    iget-object v7, v0, Lcom/android/incallui/ConferenceManagerPresenter;->mCallerIds:[Ljava/lang/String;
    ...
    const-string v8, "add call getCallById - callId :"
    ...
    invoke-static {v0, v7, v8}, Lcom/android/incallui/Log;->d(Ljava/lang/Object;Ljava/lang/String;Z)V

    move-object/from16 v0, p1

    invoke-virtual {v0, v14}, Lcom/android/incallui/CallList;->getCallById(Ljava/lang/String;)Lcom/android/incallui/Call;
    ...
    invoke-virtual {v0, v14}, Lcom/android/incallui/CallList;->getVzwConfCallById(Ljava/lang/String;)Lcom/android/incallui/Call;
    ...
    const-string v8, "VZW_VOLTE_UI_CONF add call getChildCallIdsForVzw - callId :"
    ...
    const-string v8, "VZW_VOLTE_UI_CONF add call getDisconnectedChildCallIdsForVzw - callId :"
    ...
    const-string v7, "VZW_VOLTE_UI_CONF add call getChildCallIds - callId :"
    ...
    :cond_d
    new-instance v1, Lcom/android/incallui/ConferenceManagerPresenter$3;

    move-object/from16 v0, p0

    invoke-direct {v1, v0}, Lcom/android/incallui/ConferenceManagerPresenter$3;-><init>(Lcom/android/incallui/ConferenceManagerPresenter;)V
    ...
    const-string v7, "VZW_VOLTE_UI_CONF calls.size() : "
    ...
    const-string v7, "Number of calls is "
    ...
    :cond_11
    invoke-static/range {v18 .. v18}, Lcom/android/incallui/util/CallTypeUtils;->isPSDomain(Lcom/android/incallui/Call;)Z
    ...
    iget-object v7, v0, Lcom/android/incallui/ConferenceManagerPresenter;->mContext:Landroid/content/Context;

    move/from16 v0, v16

    invoke-interface {v1, v7, v15, v0}, Lcom/android/incallui/ConferenceManagerUi;->update(Landroid/content/Context;Ljava/util/List;Z)V
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/incallui/Call;->getSecCall()Lcom/android/incallui/SecCall;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/incallui/SecCall;->getHDIcon()I

    move-result v1

    if-lez v1, :cond_17

    invoke-static/range {v17 .. v17}, Lcom/android/incallui/util/SecCallExtraUtils;->getIsEpdgCall(Lcom/android/incallui/Call;)Z
    ...
    invoke-virtual {v1, v7}, Lcom/android/incallui/ContactInfoCache;->getInfo(Ljava/lang/String;)Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;
    ...
    :cond_19
    invoke-static/range {v17 .. v17}, Lcom/android/incallui/util/InCallUtils;->isHasWBorSWB(Lcom/android/incallui/Call;)Z
    ...
    invoke-virtual/range {v7 .. v12}, Lcom/android/incallui/ConferenceManagerPresenter;->updateManageConferenceRow(ILcom/android/incallui/ContactInfoCache$ContactCacheEntry;ZZZ)V
