...
.method public onCallListChange(Lcom/android/incallui/CallList;)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/CallList;->getBackgroundCall()Lcom/android/incallui/Call;
    ...
    const-string v19, "onCallListChange state:"
    ...
    const-string v19, "disconnect() sending intent remote_number: "
    ...
    const-string v18, "com.samsung.rcs.contentsharing.action.DISCONNECT_SHARE"
    ...
    const-string v18, "remote_number putExtra in intent"
    ...
    const-string v18, "remote_number"
    ...
    invoke-static {v6}, Lcom/android/incallui/util/VideoCallUtils;->getVideoResolution(Lcom/android/incallui/Call;)I
    ...
    iget-boolean v0, v8, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isChangedHideStatus:Z
    ...
    :cond_b
    const-string v18, "NTT DOCOMO : unregisterContentObserver "
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/InCallApp;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    const/16 v18, 0x0

    move/from16 v0, v18

    iput-boolean v0, v8, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->hide_status:Z

    const/16 v18, 0x0

    move/from16 v0, v18

    iput-boolean v0, v8, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isChangedHideStatus:Z

    :cond_c
    const-string v18, "panic_mode_swa"
    ...
    invoke-virtual {v12}, Lcom/android/incallui/Call;->isEmergencyCall()Z
    ...
    const-string v19, "onCallListChange oldState= "
    ...
    const-string v19, "onCallListChange newState changed to "
    ...
    const-string v19, "Phone switching state: "
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/incallui/util/InCallUtils;->isEcholocateEnabled(Ljava/lang/String;)Z
    ...
    sget-object v20, Lcom/android/incallui/operator/usa/InCallUIConstants$UICallState;->CALL_PRESSED:Lcom/android/incallui/operator/usa/InCallUIConstants$UICallState;

    invoke-virtual/range {v20 .. v20}, Lcom/android/incallui/operator/usa/InCallUIConstants$UICallState;->ordinal()I

    move-result v20

    invoke-virtual/range {v18 .. v20}, Lcom/android/incallui/TelecomAdapter;->senduiCallState(Ljava/lang/String;I)V

    :cond_f
    :goto_2
    const-string v18, "lock_screen_during_call"
    ...
    sget-object v18, Lcom/android/incallui/InCallPresenter$InCallState;->INCALL:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    sget-object v18, Lcom/android/incallui/InCallPresenter$InCallState;->OUTGOING:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/InCallApp;->isLocked()Z

    move-result v18

    if-eqz v18, :cond_17

    const-string v18, "Skip onCallListChange during UI Locked"
    ...
    invoke-virtual {v0, v6, v1}, Lcom/android/incallui/InCallPresenter;->startContactInfoSearch(Lcom/android/incallui/Call;Z)V
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/incallui/util/InCallUtils;->sendEcholocateUIState(I)V

    goto :goto_2

    :cond_17
    const-string v18, "multiend_point"
    ...
    const-string v18, "Launching InCall UI when state From NO_CALL to INCALL"
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/incallui/util/SystemServiceUtils;->pokeUserActivity(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/accessory/CoverViewManager;->updateCoverScreenTimeOut()V
    ...
    check-cast v11, Lcom/android/incallui/InCallPresenter$InCallStateListener;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/incallui/InCallPresenter$InCallState;->toString()Ljava/lang/String;
    ...
    invoke-interface {v11, v15, v0, v1}, Lcom/android/incallui/InCallPresenter$InCallStateListener;->onStateChange(Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/InCallPresenter$InCallState;Lcom/android/incallui/CallList;)V
    ...
    invoke-virtual {v0, v9}, Lcom/android/incallui/InCallActivity;->dismissKeyguard(Z)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/InCallActivity;->updateKeepScreenOnFlag()V
    ...
    sget-object v20, Lcom/android/incallui/InCallPresenter$InCallState;->INCOMING:Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/CallList;->getIncomingCall()Lcom/android/incallui/Call;
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/android/incallui/InCallActivity;->setStatusBar(Z)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/CallList;->hasIncomingCall()Z
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/CallList;->getActiveCall()Lcom/android/incallui/Call;
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/android/incallui/secrcs/RcsShareUI;->isShareActive(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/incallui/CallList;->getActiveCall()Lcom/android/incallui/Call;

    move-result-object v20

    invoke-virtual/range {v18 .. v20}, Lcom/android/incallui/secrcs/RcsShareUI;->resumeShare(Landroid/content/Context;Lcom/android/incallui/Call;)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/incallui/InCallActivity;->getRcsInvitation()Lcom/android/incallui/secrcs/RcsInvitation;
    ...
    const-string v18, "auto_call_test"
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/android/incallui/util/VTAutoTestProxy;->handleMessage(I)V
    ...
    const-string v19, "tty notification on active call, is ACTIVE isActivityStarted() : "
    ...
    const-string v19, ", InCallUISystemDB.getTtyNotification() : "
    ...
    const-string v18, "tty notification on active call, show!"
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/android/incallui/InCallActivity;->onTtyNotification(Z)V

    :cond_23
    const-string v18, "automatic_answering_machine"
    ...
    :cond_25
    const-string v18, "smart_auto_answering"
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/incallui/operator/kor/SmartAnswerUtils;->setSmartAnswered(Z)V

    :cond_26
    sget v18, Lcom/android/incallui/service/vt/VideoCallCapability;->HANDOVER_NOTIFICATION:I

    invoke-static/range {v18 .. v18}, Lcom/android/incallui/service/vt/VideoCallCapability;->can(I)Z
...
.method public startContactInfoSearch(Lcom/android/incallui/Call;Z)V
    ...
    invoke-direct {v2, p0, v4}, Lcom/android/incallui/InCallPresenter$ContactInfoCallback;-><init>(Lcom/android/incallui/InCallPresenter;Lcom/android/incallui/InCallPresenter$1;)V

    invoke-virtual {v0, p1, v3, v2}, Lcom/android/incallui/ContactInfoCache;->findInfoForContactChanges(Lcom/android/incallui/Call;ZLcom/android/incallui/ContactInfoCache$ContactInfoCacheCallback;)V
    ...
    invoke-virtual {v0, p1, v3, v2}, Lcom/android/incallui/ContactInfoCache;->findInfo(Lcom/android/incallui/Call;ZLcom/android/incallui/ContactInfoCache$ContactInfoCacheCallback;)V
...
.method public updateContactInfo()V
    ...
    invoke-virtual {p0, v1, v5}, Lcom/android/incallui/InCallPresenter;->startContactInfoSearch(Lcom/android/incallui/Call;Z)V
