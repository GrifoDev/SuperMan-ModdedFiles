...
.method public static a(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/h;->b(Landroid/content/Context;)I
...
.method public static a(ILandroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p2}, Lcom/google/android/gms/common/internal/p;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/p;

    move-result-object v0

    invoke-static {p0, p1, v0, p3}, Lcom/google/android/gms/common/c;->a(ILandroid/app/Activity;Lcom/google/android/gms/common/internal/p;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public static a(ILandroid/app/Activity;Lcom/google/android/gms/common/internal/p;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    invoke-static {p1, p0, v1}, Lcom/google/android/gms/common/internal/o;->a(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/o;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/o;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(ILandroid/content/Context;)V
    ...
    invoke-static {p1, p0}, Lcom/google/android/gms/common/c;->b(Landroid/content/Context;I)Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/google/android/gms/common/c;->g(Landroid/content/Context;)V

    :goto_0
    return-void

    :cond_2
    invoke-static {p0, p1}, Lcom/google/android/gms/common/c;->c(ILandroid/content/Context;)V
...
.method private static a(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/google/android/gms/common/c;->a(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
...
.method private static a(ILandroid/content/Context;Ljava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p1, p0}, Lcom/google/android/gms/common/internal/o;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1, p0, v2}, Lcom/google/android/gms/common/internal/o;->b(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0}, Lcom/google/android/gms/common/c;->b(I)Z
    ...
    :cond_5
    new-instance v3, Landroid/support/v4/app/ac$d;

    invoke-direct {v3, p1}, Landroid/support/v4/app/ac$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v4}, Landroid/support/v4/app/ac$d;->a(I)Landroid/support/v4/app/ac$d;

    move-result-object v3

    invoke-virtual {v3, v1}, Landroid/support/v4/app/ac$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/ac$d;
    ...
    invoke-virtual {v1, v6}, Landroid/support/v4/app/ac$d;->b(Z)Landroid/support/v4/app/ac$d;

    move-result-object v1

    invoke-virtual {v1, p3}, Landroid/support/v4/app/ac$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ac$d;
...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/d;->a(Landroid/support/v4/app/q;Ljava/lang/String;)V
...
.method public static a(I)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/h;->c(I)Z
...
.method public static a(ILandroid/app/Activity;Landroid/support/v4/app/Fragment;ILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    :goto_0
    invoke-static {p0, p1, v0, p4}, Lcom/google/android/gms/common/c;->a(ILandroid/app/Activity;Lcom/google/android/gms/common/internal/p;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    :cond_0
    invoke-static {p2, v0, p3}, Lcom/google/android/gms/common/internal/p;->a(Landroid/support/v4/app/Fragment;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/p;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/h;->d(Landroid/content/Context;I)Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/h;->e(Landroid/content/Context;I)Z
...
.method private static c(ILandroid/content/Context;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/google/android/gms/common/c;->a(ILandroid/content/Context;Ljava/lang/String;)V
