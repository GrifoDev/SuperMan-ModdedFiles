...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->baseClass:Ljava/lang/Class;

    const-string v0, "android.bluetooth.BluetoothClass"

    invoke-static {v0}, Lcom/android/incallui/wrapper/ReflectUtil;->classForName(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->baseClass:Ljava/lang/Class;

    sget-object v0, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->baseClass:Ljava/lang/Class;

    const-string v2, "doesClassMatch"
    ...
    sput-object v0, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->sMethodDoesClassMatch:Ljava/lang/reflect/Method;

    :try_start_0
    const-class v0, Landroid/bluetooth/BluetoothClass$Device;

    const-string v2, "PROFILE_HEADSET"
    ...
    const-string v4, "ReflectUtil.getFieldValue(), PROFILE_HEADSET : "
    ...
    sput v0, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->PROFILE_HEADSET:I

    :goto_1
    :try_start_1
    const-class v0, Landroid/bluetooth/BluetoothClass$Device;

    const-string v2, "PROFILE_A2DP"
    ...
    const-string v3, "ReflectUtil.getFieldValue(), PROFILE_A2DP : "
    ...
    sput v0, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->PROFILE_A2DP:I
    ...
    :cond_0
    sput v6, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->PROFILE_HEADSET:I
    ...
    :cond_1
    sput v7, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->PROFILE_A2DP:I
...
.method public static doesClassMatch(Landroid/bluetooth/BluetoothClass;I)Z
    ...
    sget-object v0, Lcom/android/incallui/wrapper/BluetoothClassWrapper;->sMethodDoesClassMatch:Ljava/lang/reflect/Method;
    ...
    const-string v0, "BluetoothClassWrapper"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Success sMethodDoesClassMatch, Match : "
