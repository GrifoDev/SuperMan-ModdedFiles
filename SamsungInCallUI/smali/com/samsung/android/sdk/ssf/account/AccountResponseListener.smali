...
.method public onError(ILcom/android/volley/VolleyError;Ljava/lang/Object;)V
    ...
    :goto_0
    iget-object v2, p0, Lcom/samsung/android/sdk/ssf/account/AccountResponseListener;->mSsfListener:Lcom/samsung/android/sdk/ssf/SsfListener;
    ...
    :try_start_1
    const-class v4, Lcom/samsung/android/sdk/ssf/account/io/AccountErrorResponse;
    ...
    invoke-virtual {v0}, Lcom/samsung/android/sdk/ssf/account/io/AccountErrorResponse;->getRcode()J

    move-result-wide v4

    iput-wide v4, v2, Lcom/samsung/android/sdk/ssf/SsfResult;->serverErrorCode:J

    invoke-virtual {v0}, Lcom/samsung/android/sdk/ssf/account/io/AccountErrorResponse;->getRmsg()Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Lcom/samsung/android/sdk/ssf/SsfResult;->serverErrorMsg:Ljava/lang/String;

    iget v3, v2, Lcom/samsung/android/sdk/ssf/SsfResult;->httpStatusCode:I

    invoke-virtual {v0, v3}, Lcom/samsung/android/sdk/ssf/account/io/AccountErrorResponse;->getStatusCode(I)I

    move-result v3

    iput v3, v2, Lcom/samsung/android/sdk/ssf/SsfResult;->resultCode:I

    iget v3, v2, Lcom/samsung/android/sdk/ssf/SsfResult;->resultCode:I
    ...
    :cond_8
    invoke-virtual {v0}, Lcom/samsung/android/sdk/ssf/account/io/AccountErrorResponse;->getLeftBlockingHour()I
