...
.method private praseServerError(Lcom/android/volley/VolleyError;Lcom/samsung/android/sdk/ssf/SsfResult;)V
    ...
    const-class v0, Lcom/samsung/android/sdk/ssf/contact/io/ContactErrorResponse;
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/android/sdk/ssf/contact/io/ContactErrorResponse;->getStatusCode(I)I

    move-result v1

    iput v1, p2, Lcom/samsung/android/sdk/ssf/SsfResult;->resultCode:I

    invoke-virtual {v0}, Lcom/samsung/android/sdk/ssf/contact/io/ContactErrorResponse;->getRcode()J

    move-result-wide v2

    iput-wide v2, p2, Lcom/samsung/android/sdk/ssf/SsfResult;->serverErrorCode:J

    invoke-virtual {v0}, Lcom/samsung/android/sdk/ssf/contact/io/ContactErrorResponse;->getRmsg()Ljava/lang/String;
...
.method public onError(ILcom/android/volley/VolleyError;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/sdk/ssf/contact/server/ContactResponseListener;->mFuture:Lcom/android/volley/toolbox/RequestFuture;

    if-eqz v0, :cond_0

    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/sdk/ssf/contact/server/ContactResponseListener;->typeArgumentClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, p2, v0}, Lcom/samsung/android/sdk/ssf/contact/server/ContactResponseListener;->updateSsfResult(Lcom/android/volley/VolleyError;Lcom/samsung/android/sdk/ssf/SsfResult;)V
