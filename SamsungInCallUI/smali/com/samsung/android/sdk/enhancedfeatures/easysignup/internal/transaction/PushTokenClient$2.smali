...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Boolean;
    ...
    :try_start_0
    const-string v3, "PREFS_GCMID"

    const-string v4, ""

    invoke-static {v3, v4}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/EPref;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "PushTokenClient"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "pref value of GCM ID is "
    ...
    const-string v0, "GCM APP ID was null"

    const-string v3, "PushTokenClient"

    invoke-static {v0, v3}, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/util/ELog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v2, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/PushTokenClient$2;->val$context:Landroid/content/Context;
    ...
    invoke-virtual {v2, v4}, Lcom/google/android/gms/gcm/a;->a([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/CommonPref;->setGcmRegId(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v3, "RegisterGcm. error: "
...
.method protected onPostExecute(Ljava/lang/Boolean;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/PushTokenClient$2;->val$handler:Landroid/os/Handler;
    ...
    iget-object v1, p0, Lcom/samsung/android/sdk/enhancedfeatures/easysignup/internal/transaction/PushTokenClient$2;->val$handler:Landroid/os/Handler;
