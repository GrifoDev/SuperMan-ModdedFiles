.class public Lcom/samsung/android/settings/qstile/SecDevelopmentTileConfigFragment;
.super Lcom/android/settings/SettingsPreferenceFragment;
.source "SecDevelopmentTileConfigFragment.java"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/qstile/SecDevelopmentTileConfigFragment;->getPrefContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p0}, Lcom/samsung/android/settings/qstile/SecDevelopmentTileConfigFragment;->getPreferenceManager()Landroid/support/v7/preference/PreferenceManager;
    ...
    invoke-virtual {p0, v9}, Lcom/samsung/android/settings/qstile/SecDevelopmentTileConfigFragment;->setPreferenceScreen(Landroid/support/v7/preference/PreferenceScreen;)V

    invoke-virtual {p0}, Lcom/samsung/android/settings/qstile/SecDevelopmentTileConfigFragment;->getPreferenceScreen()Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/qstile/SecDevelopmentTileConfigFragment;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    :goto_1
    new-instance v7, Landroid/support/v14/preference/SecSwitchPreference;

    invoke-direct {v7, v1}, Landroid/support/v14/preference/SecSwitchPreference;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v9}, Landroid/support/v14/preference/SecSwitchPreference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v9, v8, Landroid/content/pm/ServiceInfo;->name:Ljava/lang/String;

    invoke-virtual {v7, v9}, Landroid/support/v14/preference/SecSwitchPreference;->setKey(Ljava/lang/String;)V

    invoke-virtual {v7, v0}, Landroid/support/v14/preference/SecSwitchPreference;->setChecked(Z)V

    invoke-virtual {v7, v12}, Landroid/support/v14/preference/SecSwitchPreference;->setPersistent(Z)V
