...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iput-object v3, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mText:Landroid/widget/TextView;
    ...
    iput-object v3, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mIcon:Landroid/widget/ImageView;
    ...
    iput-object v3, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mCheck:Landroid/widget/CheckBox;
    ...
    iput-object v3, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mContainer:Landroid/widget/RelativeLayout;
    ...
    iget-object v4, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mText:Landroid/widget/TextView;
    ...
    iget-object v3, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mIcon:Landroid/widget/ImageView;
    ...
    :goto_1
    iget-object v4, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mCheck:Landroid/widget/CheckBox;
    ...
    iget-object v3, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mContainer:Landroid/widget/RelativeLayout;
    ...
    iget-object v5, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mContainer:Landroid/widget/RelativeLayout;

    invoke-virtual {v5}, Landroid/widget/RelativeLayout;->getPaddingTop()I

    move-result v5

    iget-object v6, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mContainer:Landroid/widget/RelativeLayout;

    invoke-virtual {v6}, Landroid/widget/RelativeLayout;->getPaddingRight()I

    move-result v6

    iget-object v7, v0, Lcom/samsung/android/settings/accessories/LedCoverCallerIDList$ViewHolder;->mContainer:Landroid/widget/RelativeLayout;
