...
.method private bootstrapDB(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v0, "CREATE VIRTUAL TABLE prefs_index USING fts4(_id, locale, data_rank, data_title, data_title_en, data_title_normalized, data_title_hex, data_summary_on, data_summary_on_normalized, data_summary_on_hex, data_summary_off, data_summary_off_normalized, data_entries, data_keywords, screen_title, class_name, icon, intent_action, intent_target_package, intent_target_class, enabled, data_key_reference, user_id, payload_type, payload, menu_type, menu_path, category_id, extras, rank_path);"
    ...
    const-string/jumbo v0, "CREATE TABLE saved_queries(_id  INTEGER PRIMARY KEY AUTOINCREMENT , query VARCHAR(64) NOT NULL, title_eng, timestamp INTEGER)"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "CREATE VIRTUAL TABLE site_map USING fts4(parent_class, child_class, parent_title, child_title)"
...
.method public static clearCachedIndexed(Landroid/content/Context;)V
    .locals 2
...
.method private dropTables(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v0}, Lcom/android/settings/search/IndexDatabaseHelper;->clearCachedIndexed(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "DROP TABLE IF EXISTS site_map"
...
.method public static isBuildIndexed(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 2
...
.method public static setBuildIndexed(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
