...
.method public createJSONObj(Ljava/lang/String;Landroid/net/wifi/WifiConfiguration;Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_a
    const-string/jumbo v16, "5gPreferChecked"

    move-object/from16 v0, p0

    move-object/from16 v1, p3

    invoke-virtual {v0, v1}, Lcom/samsung/android/settings/wifi/mobileap/WifiApBackupRestore;->get5gPreferChecked(Landroid/content/Context;)I
...
.method public get5gPreferChecked(Landroid/content/Context;)I
    ...
    const-string/jumbo v2, "wifi_ap_5G_checked"
    ...
    const-string/jumbo v3, " get5gPreferChecked "
...
.method public restore(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Lcom/samsung/android/scloud/oem/lib/qbnr/ISCloudQBNRClient$QuickBackupListener;)V
    ...
    :cond_b
    const-string/jumbo v27, "5gPreferChecked"
    ...
    invoke-virtual {v0, v1, v2}, Lcom/samsung/android/settings/wifi/mobileap/WifiApBackupRestore;->set5gPreferChecked(ILandroid/content/Context;)V

    :goto_a
    const-string/jumbo v27, "last2gChannel"
    ...
    const-string/jumbo v28, "wifi_ap_last_2g_channel"

    const-string/jumbo v29, "last2gChannel"
    ...
    const-string/jumbo v28, "device doesn\'t have 5gPrefer checkbox"
...
.method public set5gPreferChecked(ILandroid/content/Context;)V
    ...
    const-string/jumbo v2, " set5gPreferChecked "
    ...
    const-string/jumbo v1, "wifi_ap_5G_checked"
