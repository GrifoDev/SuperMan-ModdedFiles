...
.method public static addProfile(Landroid/content/Context;Lcom/sec/ims/settings/ImsProfile;)Landroid/net/Uri;
    ...
    const-string/jumbo v2, "content://com.sec.ims.settings/profile"
...
.method public static getProfile(Landroid/content/Context;I)Lcom/sec/ims/settings/ImsProfile;
    ...
    const-string/jumbo v0, "ImsProfileLoader"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "getProfile: id "
    ...
    const-string/jumbo v3, "content://com.sec.ims.settings/profile/"
    ...
    const-string/jumbo v2, "getProfile: found "
    ...
    invoke-static {p0, v6}, Lcom/sec/ims/settings/ImsProfileLoader;->getImsProfileFromRow(Landroid/content/Context;Landroid/database/Cursor;)Lcom/sec/ims/settings/ImsProfile;
...
.method public static getProfileList(Landroid/content/Context;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string/jumbo v3, "persist.ims.mock.mno"
    ...
    :cond_2
    const-string/jumbo v3, "ImsProfileLoader"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "getProfileList: operator= "
    ...
    invoke-static {p0, v1}, Lcom/sec/ims/settings/ImsProfileLoader;->getProfileListWithMccMnc(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
...
.method public static getProfileListWithMccMnc(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string/jumbo v4, "getProfileListWithMccMnc: mcc="
    ...
    const-string/jumbo v3, "getProfileList: found "
    ...
    invoke-virtual {v7, v0}, Lcom/sec/ims/settings/ImsProfile;->setMcc(Ljava/lang/String;)V

    invoke-virtual {p1, v9}, Ljava/lang/String;->substring(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v7, v0}, Lcom/sec/ims/settings/ImsProfile;->setMnc(Ljava/lang/String;)V
...
.method public static updateProfile(Landroid/content/Context;Ljava/util/List;)I
    ...
    const-string/jumbo v11, "content://com.sec.ims.settings/profile/"
    ...
    invoke-static {v6}, Lcom/sec/ims/settings/ImsProfileLoader;->getContentValues(Lcom/sec/ims/settings/ImsProfile;)Landroid/content/ContentValues;
    ...
    const-string/jumbo v11, "com.sec.ims.settings"
    ...
    iget-object v12, v3, Landroid/content/ContentProviderResult;->count:Ljava/lang/Integer;
