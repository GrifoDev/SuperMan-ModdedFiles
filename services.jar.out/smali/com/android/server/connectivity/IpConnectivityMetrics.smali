...
.method private cmdList(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/server/connectivity/IpConnectivityMetrics;->mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;

    if-eqz v4, :cond_1

    iget-object v4, p0, Lcom/android/server/connectivity/IpConnectivityMetrics;->mNetdListener:Lcom/android/server/connectivity/NetdEventListenerService;

    invoke-virtual {v4, p2}, Lcom/android/server/connectivity/NetdEventListenerService;->listAsProtos(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v4, p2}, Lcom/android/server/connectivity/NetdEventListenerService;->list(Ljava/io/PrintWriter;)V
...
.method private isRateLimited(Landroid/net/ConnectivityMetricsEvent;)Z
    ...
    iget-object v1, p0, Lcom/android/server/connectivity/IpConnectivityMetrics;->mBuckets:Landroid/util/ArrayMap;

    iget-object v2, p1, Landroid/net/ConnectivityMetricsEvent;->data:Landroid/os/Parcelable;
...
.method static synthetic lambda$-com_android_server_connectivity_IpConnectivityMetrics_10868(Landroid/content/Context;)I
    .locals 4
