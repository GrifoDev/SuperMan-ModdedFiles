...
.method private getDozeComponent(I)Landroid/content/ComponentName;
    ...
    const-string/jumbo v6, "SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_AOD_DOZE_SERVICE_VERSION"
    ...
    invoke-static {v5, v6, v8, p1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string/jumbo v6, "fingerprint_screen_lock"

    invoke-static {v5, v6, v7, p1}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    :cond_0
    const-string/jumbo v4, "com.samsung.android.app.aodservice/.DozeService"
...
# virtual methods
.method synthetic lambda$-com_android_server_dreams_DreamManagerService_16923(Landroid/os/Binder;Landroid/content/ComponentName;ZZILandroid/os/PowerManager$WakeLock;)V
    .locals 7
