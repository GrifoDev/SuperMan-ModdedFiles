...
.method constructor <init>(Lcom/android/server/accounts/AccountManagerService;Lcom/android/server/accounts/AccountManagerService;Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/IAccountManagerResponse;Ljava/lang/String;ZZLjava/lang/String;ZLandroid/os/Bundle;Landroid/accounts/Account;Ljava/lang/String;ZZIZLjava/lang/String;[BLcom/android/server/accounts/AccountManagerService$UserAccounts;)V
    ...
    iput-object v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$loginOptions:Landroid/os/Bundle;

    move-object/from16 v0, p11

    iput-object v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$account:Landroid/accounts/Account;
    ...
    iput-boolean v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$notifyOnAuthFailure:Z

    move/from16 v0, p14

    iput-boolean v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$permissionGranted:Z

    move/from16 v0, p15

    iput v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$callerUid:I

    move/from16 v0, p16

    iput-boolean v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$customTokens:Z

    move-object/from16 v0, p17

    iput-object v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$callerPkg:Ljava/lang/String;

    move-object/from16 v0, p18

    iput-object v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$callerPkgSigDigest:[B

    move-object/from16 v0, p19

    iput-object v0, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$accounts:Lcom/android/server/accounts/AccountManagerService$UserAccounts;
...
.method public onResult(Landroid/os/Bundle;)V
    ...
    iget v3, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$callerUid:I
    ...
    invoke-virtual {p0, v10}, Lcom/android/server/accounts/AccountManagerService$7;->onResult(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/server/accounts/AccountManagerService$7;->onError(ILjava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/server/accounts/AccountManagerService$7;->mAccounts:Lcom/android/server/accounts/AccountManagerService$UserAccounts;

    iget-object v3, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$account:Landroid/accounts/Account;

    iget-object v4, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$callerPkg:Ljava/lang/String;

    iget-object v5, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$callerPkgSigDigest:[B

    iget-object v6, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$authTokenType:Ljava/lang/String;

    invoke-static/range {v1 .. v9}, Lcom/android/server/accounts/AccountManagerService;->-wrap21(Lcom/android/server/accounts/AccountManagerService;Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/server/accounts/AccountManagerService$7;->checkKeyIntent(ILandroid/content/Intent;)V
    ...
    iget-object v6, p0, Lcom/android/server/accounts/AccountManagerService$7;->val$accounts:Lcom/android/server/accounts/AccountManagerService$UserAccounts;
