...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hidl/manager/V1_0/IServiceManager;
    ...
    :cond_0
    const-string/jumbo v5, "android.hidl.manager@1.0::IServiceManager"
    ...
    instance-of v5, v3, Landroid/hidl/manager/V1_0/IServiceManager;

    if-eqz v5, :cond_1

    check-cast v3, Landroid/hidl/manager/V1_0/IServiceManager;

    return-object v3

    :cond_1
    new-instance v4, Landroid/hidl/manager/V1_0/IServiceManager$Proxy;

    invoke-direct {v4, p0}, Landroid/hidl/manager/V1_0/IServiceManager$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v4}, Landroid/hidl/manager/V1_0/IServiceManager;->interfaceChain()Ljava/util/ArrayList;
