...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/usb/V1_0/IUsbCallback;
    ...
    instance-of v5, v3, Landroid/hardware/usb/V1_0/IUsbCallback;

    if-eqz v5, :cond_1

    check-cast v3, Landroid/hardware/usb/V1_0/IUsbCallback;

    return-object v3

    :cond_1
    new-instance v4, Landroid/hardware/usb/V1_0/IUsbCallback$Proxy;

    invoke-direct {v4, p0}, Landroid/hardware/usb/V1_0/IUsbCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v4}, Landroid/hardware/usb/V1_0/IUsbCallback;->interfaceChain()Ljava/util/ArrayList;
