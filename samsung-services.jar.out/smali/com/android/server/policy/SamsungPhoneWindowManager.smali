...
.method static synthetic -get10(Lcom/android/server/policy/SamsungPhoneWindowManager;)I
    .locals 1
...
.method static synthetic -get11()Lcom/samsung/android/os/SemDvfsManager;
    .locals 1
...
.method static synthetic -get12(Lcom/android/server/policy/SamsungPhoneWindowManager;)Z
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/policy/SamsungPhoneWindowManager;)Landroid/widget/Toast;
    .locals 1
...
.method static synthetic -set12(Lcom/android/server/policy/SamsungPhoneWindowManager;Landroid/widget/Toast;)Landroid/widget/Toast;
    .locals 0
...
.method public applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;Z)V
    ...
    iget-object v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mHideSViewCoverWindowState:Landroid/view/WindowManagerPolicy$WindowState;
    ...
    invoke-interface {v6}, Lcom/samsung/android/view/IWindowStateBridge;->getCoverMode()I
    ...
    iget-object v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mAppsToBeHiddenBySViewCover:Ljava/util/HashSet;
    ...
    iget-boolean v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mShowingSViewCover:Z

    iput-boolean v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mForceStatusBarFromSViewCover:Z
    ...
    const-string/jumbo v8, "Hide sview cover :  SViewCoverWindow = "
    ...
    iget-object v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mMultiPhoneWindowManager:Lcom/android/server/policy/MultiPhoneWindowManager;

    invoke-virtual {v6, v9}, Lcom/android/server/policy/MultiPhoneWindowManager;->setOverlappedFreeformWithNaviBar(Z)V
    ...
    :cond_4
    :goto_3
    iget-object v6, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mFakeFocusedWindow:Landroid/view/WindowManagerPolicy$WindowState;

    if-nez v6, :cond_5

    iget v6, p2, Landroid/view/WindowManager$LayoutParams;->samsungFlags:I
    ...
    invoke-interface {v6}, Lcom/samsung/android/view/IWindowStateBridge;->willBeHideSViewCoverOnce()Z
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/policy/PhoneWindowManager;->isFullscreen(Landroid/view/WindowManager$LayoutParams;)Z
...
.method public beginLayoutLw(IIII)V
    ...
    iget v2, v2, Lcom/android/server/policy/PhoneWindowManager;->mOverscanScreenWidth:I

    sub-int/2addr v2, v11

    sub-int/2addr v2, v12

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mOverscanScreenWidth:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget-object v2, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v2, Lcom/android/server/policy/PhoneWindowManager;->mOverscanScreenHeight:I

    sub-int/2addr v2, v10

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mOverscanScreenHeight:I
    ...
    iput v2, v3, Lcom/android/server/policy/PhoneWindowManager;->mRestrictedOverscanScreenLeft:I

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mOverscanScreenLeft:I
    ...
    invoke-virtual {v1, v4, v2, p1, v3}, Landroid/graphics/Rect;->set(IIII)V
    ...
    iget v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeBarPosition:I
    ...
    :pswitch_1
    iget v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeBarHorizontalPosition:I
    ...
    invoke-virtual {v1, v2, v4, v3, p2}, Landroid/graphics/Rect;->set(IIII)V
    ...
    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableBottom:I

    iget v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeSize:I

    sub-int/2addr v2, v3

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableBottom:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableFullscreenBottom:I

    iget v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeSize:I

    sub-int/2addr v2, v3

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableFullscreenBottom:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mSystemBottom:I
    ...
    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mDockBottom:I
    ...
    iget v2, v2, Lcom/android/server/policy/PhoneWindowManager;->mDockBottom:I
    ...
    iput v2, v3, Lcom/android/server/policy/PhoneWindowManager;->mVoiceContentBottom:I

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mContentBottom:I
    ...
    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableLeft:I

    iget v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeSize:I

    add-int/2addr v2, v3

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableLeft:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableFullscreenLeft:I

    iget v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeSize:I

    add-int/2addr v2, v3

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableFullscreenLeft:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mSystemLeft:I
    ...
    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mDockLeft:I
    ...
    iget v2, v2, Lcom/android/server/policy/PhoneWindowManager;->mDockLeft:I
    ...
    iput v2, v3, Lcom/android/server/policy/PhoneWindowManager;->mVoiceContentLeft:I

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mContentLeft:I
    ...
    iget v2, v2, Lcom/android/server/policy/PhoneWindowManager;->mDockRight:I
    ...
    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableRight:I

    iget v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeSize:I

    sub-int/2addr v2, v3

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableRight:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableFullscreenRight:I

    iget v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mCarModeSize:I

    sub-int/2addr v2, v3

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mStableFullscreenRight:I

    iget-object v1, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mPWM:Lcom/android/server/policy/PhoneWindowManager;

    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mSystemRight:I
    ...
    iget v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mDockRight:I
    ...
    iput v2, v3, Lcom/android/server/policy/PhoneWindowManager;->mVoiceContentRight:I

    iput v2, v1, Lcom/android/server/policy/PhoneWindowManager;->mContentRight:I
...
.method public finishPostLayoutPolicyLw(I)I
    ...
    const-string/jumbo v5, "finishPostLayoutPolicyLw: mHideSViewCoverWindowState ="
    ...
    iget-boolean v3, v3, Lcom/android/server/policy/PhoneWindowManager;->mForceStatusBarFromKeyguard:Z
    ...
    invoke-virtual {v3}, Lcom/android/server/policy/NaviBarForceTouchManager;->dismissKeyguardByPendingRequest()V

    :cond_4
    iget-boolean v3, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mWallpaperTargetMayChage:Z
...
.method public notifyCoverSwitchStateChanged(JZ)V
    ...
    const-string/jumbo v4, "CscFeature_Common_DisableNfcHwKeypad"
    ...
    iget-object v2, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mMultiPhoneWindowManager:Lcom/android/server/policy/MultiPhoneWindowManager;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/policy/MultiPhoneWindowManager;->setMultiWindowEnabled(ZLjava/lang/String;)V
...
.method public screenTurnedOff()V
    ...
    const-string/jumbo v2, "com.sec.feature.usb_authentication"
...
.method public setSafeModeReason(IIIIII)V
    .locals 2
...
.method public systemReady(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)V
    ...
    iput-object v0, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mGearVrManagerInternal:Lcom/samsung/android/vr/GearVrManagerInternal;
...
.method public updateSettings()V
    ...
    const-string/jumbo v33, "navigationbar_key_order"
    ...
    const-string/jumbo v33, "game_navigationbar_swipe_up_lock"
    ...
    const-string/jumbo v35, "CscFeature_Common_ConfigBikeMode"
    ...
    const-string/jumbo v35, "bikemode"
    ...
    const-string/jumbo v35, "isBikeMode"
...
.method public updateSystemBarsLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManagerPolicy$WindowState;II)I
    ...
    iput v4, p0, Lcom/android/server/policy/SamsungPhoneWindowManager;->mForceEnabledSystemUiFlags:I
...
.method public updateSystemUiVisibilityLw()V
    ...
    new-instance v4, Lcom/android/server/policy/SamsungPhoneWindowManager$37;

    invoke-direct {v4, p0}, Lcom/android/server/policy/SamsungPhoneWindowManager$37;-><init>(Lcom/android/server/policy/SamsungPhoneWindowManager;)V
