...
.method private readStateFromFileLocked(Ljava/io/FileInputStream;)V
    ...
    invoke-direct {v6, v0}, Ljava/io/BufferedReader;-><init>(Ljava/io/Reader;)V
    :try_end_11
    .catch Ljava/io/IOException; {:try_start_11 .. :try_end_11} :catch_2e
...
.method public bindRemoteViewsService(ILandroid/content/Intent;Landroid/os/IBinder;)V
    ...
    const-string/jumbo v16, "bindRemoteViewsService : not loaded u="
    ...
    const-string/jumbo v16, " cocktail="
    ...
    const-string/jumbo v15, "bad cocktailId"
    ...
    iget v15, v0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;->mUserId:I

    const/16 v16, 0x1000

    move/from16 v0, v16

    invoke-interface {v13, v3, v0, v15}, Landroid/content/pm/IPackageManager;->getServiceInfo(Landroid/content/ComponentName;II)Landroid/content/pm/ServiceInfo;

    move-result-object v9

    const-string/jumbo v13, "android.permission.BIND_REMOTEVIEWS"
    ...
    const-string/jumbo v16, "Selected service does not require android.permission.BIND_REMOTEVIEWS: "
    ...
    const-string/jumbo v16, "Unknown component "
    ...
    const-string/jumbo v16, "CocktailServiceImpl of user "
    ...
    const-string/jumbo v16, " binding to provider on user "
    ...
    invoke-virtual {v13, v0, v4, v1, v15}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
...
.method public onConfigurationChanged()V
    ...
    const-string/jumbo v9, "onConfigurationChanged : not loaded u="
...
.method public setOnPullPendingIntent(Ljava/lang/String;IILandroid/app/PendingIntent;)V
    ...
    const-string/jumbo v8, "setPullToRefresh: u="
    ...
    const-string/jumbo v8, "setPullToRefresh : invalid cocktailId="
    ...
    const-string/jumbo v7, "setPullToRefresh : no active host"
    ...
    const-string/jumbo v9, "setPullToRefresh: category not matched "
    ...
    const-string/jumbo v8, "setPullToRefresh : "
...
.method public startListening(Lcom/samsung/android/cocktailbar/ICocktailHost;Ljava/lang/String;I)V
    ...
    iget v7, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;->mHostCategory:I
